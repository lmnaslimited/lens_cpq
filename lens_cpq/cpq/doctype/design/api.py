...
def fn_get_formated_item_variants(item_name):
    ...
    field or a select-type field. The configuration includes default values, options,
    and range specifications where applicable.
    ...
    if la_non_numeric:
        ...
        for ld_value in la_attribute_values:
            # setdefault is a python built-in method for grouping
